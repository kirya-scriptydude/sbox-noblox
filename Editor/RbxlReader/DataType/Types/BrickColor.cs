...
/// <summary>
/// heavily stolen from cloneTrooper repo.
/// </summary>
public class BrickColor {
    ...
    static BrickColor() {
        ByNumber = BrickColorCollection.ColorMap.ToDictionary(brickColor => brickColor.Number);
        ByPalette = BrickColorCollection.PaletteMap.Select(number => ByNumber[number]).ToList();
    }
    ...
    public BrickColor(int num, uint rgb, string name) {
    ...
    public static BrickColor FromNumber(int num) {
...
public static class BrickColorCollection {
